...
public class HelloController implements Initializable {
    ...
    private void showGraphView() {
        try {
            ...
            stage.setTitle("Graf Page");
            stage.setScene(new Scene(root));

            // Menutup tampilan utama (jika diperlukan)
            Stage mainStage = (Stage) graf.getScene().getWindow();
            mainStage.close();
            ...
            e.printStackTrace();
            // Tindakan penanganan kesalahan yang sesuai
        }
    }
    ...
    private List<Buku> books() {
        ...
        Buku buku2 = new Buku("50 PRAYERS FROM THE HOLY QUR'AN", "A.K", new String[] {"Islam"}, "/img/buku2.jpg",
                "Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1");
        ls.add(buku2);
        ...
        Buku buku6 = new Buku("Gamebell", "Dr. Hadi Utomo", new String[] {"Detective"}, "/img/buku3.jpg",
                "Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1 Sinopsis1");
        ls.add(buku6);
        ...
        Buku buku8 = new Buku("Football", "Hartswood Films", new String[] {"Detective", "Islam"}, "/img/buku3.jpg",
                "Sinopsis Sinopsis Sinopsis Sinopsis Sinopsis Sinopsis Sinopsis Sinopsis Sinopsis Sinopsis Sinopsis Sinopsis Sinopsis Sinopsis Sinopsis Sinopsis Sinopsis Sinopsis");
        ls.add(buku8);
